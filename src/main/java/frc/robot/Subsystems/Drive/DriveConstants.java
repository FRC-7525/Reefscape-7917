...
public final class DriveConstants {
	...
	public static final Pose2d[][] CAGES = {
		{
			new Pose2d(new Translation2d(7.5, 7.25), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 7.25), Rotation2d.fromDegrees(-180)),
		},
		{
			new Pose2d(new Translation2d(7.5, 6.2), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 6.2), Rotation2d.fromDegrees(-180)),
		},
		{
			new Pose2d(new Translation2d(7.5, 5.1), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 5.1), Rotation2d.fromDegrees(-180)),
		},
		{
			new Pose2d(new Translation2d(7.5, 3), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 3), Rotation2d.fromDegrees(-180)),
		},
		{
			new Pose2d(new Translation2d(7.5, 1.9), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 1.9), Rotation2d.fromDegrees(-180)),
		},
		{
			new Pose2d(new Translation2d(7.5, 0.8), Rotation2d.fromDegrees(0)),
			new Pose2d(new Translation2d(10, 0.8), Rotation2d.fromDegrees(-180)),
		},
	};
	...
	public static final ChassisSpeeds SIDEWAYS_TO_RIGHT_CHASSIS_SPEED = new ChassisSpeeds(
		-0.875,
		0,
		0
	);
	...
	public static RobotConfig getRobotConfig() {
		try {
			...
			return new RobotConfig(
				79,
				6.833,
				new ModuleConfig(0.025, 4.6, 1.542, DCMotor.getNEO(4), 40, 1),
				2
			);
		}
	}
