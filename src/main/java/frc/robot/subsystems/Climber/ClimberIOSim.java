...
public class ClimberIOSim implements ClimberIO {
    ...
    public ClimberIOSim() {
        ...
        climberSim = new DCMotorSim(LinearSystemId.createDCMotorSystem(DCMotor.getNEO(Sim.NUM_MOTORS), Sim.MOTOR_MOI.magnitude(), MOTOR_GEARING), DCMotor.getNEO(Sim.NUM_MOTORS));
